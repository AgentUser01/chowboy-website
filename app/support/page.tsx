  ...
  return (
    <div className="pt-20">
      <section className="container mx-auto px-6 py-20 max-w-4xl">
        <h1 className="text-5xl font-bold text-slate mb-8">Support</h1>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <h2 className="text-3xl font-bold text-slate mt-12 mb-4">Contact Us</h2>
          <p>
          ...
          <h2 className="text-3xl font-bold text-slate mt-12 mb-4">Frequently Asked Questions</h2>
          
          <h3 className="text-2xl font-semibold text-slate mt-8 mb-3">How do I import recipes?</h3>
          <p>
          ...
          <h3 className="text-2xl font-semibold text-slate mt-8 mb-3">Can I use Chowboy offline?</h3>
          <p>
            Yes! Once you&apos;ve imported recipes, they&apos;re available offline so you can cook anytime, anywhere.
          </p>

          <h3 className="text-2xl font-semibold text-slate mt-8 mb-3">How do I cancel my subscription?</h3>
          <p>
          ...
          <h3 className="text-2xl font-semibold text-slate mt-8 mb-3">Is my data secure?</h3>
          <p>
          ...
          <h2 className="text-3xl font-bold text-slate mt-12 mb-4">Feature Requests</h2>
          <p>
